package com.hua.gentlemanx2.ui.statusbar;
...
public class TranslucentBehavior extends CoordinatorLayout.Behavior<Toolbar> {
    ...
    private int mDistanceY = 0;//顶部的距离
    private static final int SHOW_SPEED = 3;//颜色变化速度
    //定义变化的颜色
    private final RgbValue RGB_VALUE = RgbValue.create(255, 192, 203);
